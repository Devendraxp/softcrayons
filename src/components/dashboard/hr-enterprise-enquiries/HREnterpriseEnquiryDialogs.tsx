...
import { type EnterpriseEnquiry, type EnterpriseEnquiryStatus } from "./HREnterpriseEnquiryRow";
import { cn } from "@/lib/utils";
import { Phone, Mail, Clock, Calendar, Building2 } from "lucide-react";
...
export function HREnterpriseViewDetailsDialog({
  enquiry,
  open,
  onOpenChange,
...
export function HREnterpriseEditNotesDialog({
  enquiry,
  open,
  onOpenChange,
  onConfirm,
