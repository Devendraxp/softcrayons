...
interface EnterpriseEnquiryRowProps {
...
export function EnterpriseEnquiryRow({
  enquiry,
  onViewDetails,
  onAssignUser,
  onStatusChange,
          ...
          {enquiry.assignedTo ? (
            <div className="flex items-center gap-2">
              ...
              <div className="min-w-0">
                <span className="text-sm truncate block">{enquiry.assignedTo.name || enquiry.assignedTo.email}</span>
                <span className="text-xs text-muted-foreground">{enquiry.assignedTo.role}</span>
              </div>
            </div>
          ) : (
          ...
          <div className="lg:hidden">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => onAssignUser?.(enquiry)}>
