...
import { type FacultyEnquiry, type FacultyEnquiryStatus } from "./HRFacultyEnquiryRow";
...
export function HRFacultyViewDetailsDialog({
  enquiry,
  open,
  onOpenChange,
...
export function HRFacultyEditNotesDialog({
  enquiry,
  open,
  onOpenChange,
  onConfirm,
