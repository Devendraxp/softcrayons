...
/**
 * GET /api/counselor/blogs
 * Get all blogs - counselors can only see their own blogs
 */
export async function GET(request: Request) {
  try {
    ...
    const filters = {
      ...
      // Counselors can only see their own blogs
      authorId: user.id,
...
/**
 * POST /api/counselor/blogs
 * Create a new blog - counselors have limited control:
