...
/**
 * GET /api/content-writer/blogs/[id]
 * Get a specific blog - Content writers can only access their own blogs
 */
...
/**
 * PUT /api/content-writer/blogs/[id]
 * Update a blog - Content writers have limited control:
...
/**
 * DELETE /api/content-writer/blogs/[id]
 * Delete a blog - Content writers can only delete their own blogs
 */
