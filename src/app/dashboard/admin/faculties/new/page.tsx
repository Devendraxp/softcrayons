...
export default function NewFacultyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("An error occurred while creating the faculty");
    } finally {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">New Faculty</h1>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter experience and achievements
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Add the technologies this faculty member specializes in
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
